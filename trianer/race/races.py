...
available_races = {
    ...
    for v in [
        ...
        dict(
            ...
            logo="ironmannice.png",
            url="https://www.ironman.com/im-france",
        ),
        dict(
        ...
        dict(
            key="Deauville (L)",
            start_time=datetime.datetime.strptime("2024-06-13 08:00", "%Y-%m-%d %H:%M"),
        ...
        dict(
            key="Bois-le-Roi (L)",
            start_time=datetime.datetime.strptime("2024-09-10 08:00", "%Y-%m-%d %H:%M"),
